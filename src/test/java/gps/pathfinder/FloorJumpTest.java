...
public class FloorJumpTest
{
	...
	{
		// Rows generated by scripts/stamp_stairs.py from field-captured exemplars — these two
		// buildings were never visited; their rows exist purely via the (id, orientation) stamp.
		...
		assertEquals(gps.pathfinder.CostUnits.fromTicks(2), up.getResult().getTotalCost());
		Pathfinder down = new Pathfinder(everythingConfig(),
