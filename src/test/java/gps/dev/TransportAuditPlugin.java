...
public class TransportAuditPlugin extends Plugin
{
	...
	// GROUND-TRUTH deck walkability: cells the player has actually stood on, keyed by deck
	// scene cell. Collision flags turned out not to encode deck walkability consistently
